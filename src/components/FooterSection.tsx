    ...
    <footer>
      <div className="socials_wrapper">
        ...
        <Link href="https://linkedin.com/in/nuuxdev" target="_blank">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 2V1H2V2H1V22H2V23H22V22H23V2H22ZM13 12V20H10V9H13V10H14V9H18V10H19V20H16V12H13ZM4 8V5H7V8H4ZM7 9V20H4V9H7Z" fill="var(--foreground)" stroke="var(--background)" stroke-width="0.2" />
          </svg>
        ...
        <Link href="https://t.me/nuuxchannel" target="_blank">
          {/* <img src="/socials/linkedin.png" alt="linkedin" /> */}
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 16V17H4V18H1V14H2V12H1V7H2V5H4V4H6V3H11V4H13V5H15V7H16V12H15V14H13V15H11V16H5Z" fill="var(--foreground)" stroke="var(--background)" stroke-width="0.2" />
            <path d="M23 11V16H22V18H23V22H20V21H19V20H13V19H11V18H9V17H12V16H14V15H16V13H17V7H18V8H20V9H22V11H23Z" fill="var(--foreground)" stroke="var(--background)" stroke-width="0.2" />
          </svg>
        </Link>
      </div>
    </footer>
